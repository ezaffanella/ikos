/*******************************************************************************
 *
 * Tests for ApronDomain with Domain = PplitePolyhedra
 *
 * Author: Maxime Arthaud (adapted by Enea Zaffanella)
 *
...
#define BOOST_TEST_MODULE test_apron_pplite_polyhedra
...
using ApronDomain = ikos::core::numeric::ApronDomain<
    ikos::core::numeric::apron::PplitePolyhedra,
    ZNumber,
    Variable >;
...
BOOST_AUTO_TEST_CASE(widening) {
  ...
  // Invalid test (failed precondition: top \subseteq inv1)
  ...
  // Invalid test (failed precondition: inv2 \subseteq inv1)
